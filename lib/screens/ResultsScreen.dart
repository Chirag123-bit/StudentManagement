...
class _ResultScreenState extends State<ResultScreen> {
  ...
  Widget build(BuildContext context) {
    List<StudentMark> lstStudents =
        ModalRoute.of(context)!.settings.arguments as List<StudentMark>;
    List<StudentMark> lstBackup =
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            ...
                            Text(student.batch.toString(),
                                textAlign: TextAlign.center),
                            Text(student.iot.toString(),
                                textAlign: TextAlign.center),
                            Text(student.api.toString(),
                                textAlign: TextAlign.center),
